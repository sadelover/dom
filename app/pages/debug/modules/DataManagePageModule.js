...
// Constants
// ------------------------------------
export const RELOAD_POINT_TABLE = 'realPage.RELOAD_POINT_TABLE';
export const RENDER_POINT_TABLE = 'realPage.RENDER_POINT_TABLE';
export const UPDATE_CONDITION = 'realPage.UPDATE_CONDITION';
export const RESET_POINT_TABLE = 'realPage.RESET_POINT_TABLE';
export const POINT_TABLE_SELECT_CHANGE = 'realPage.POINT_TABLE_SELECT_CHANGE';
export const ADD_EQUIPMENT_LIST = 'realPage.ADD_EQUIPMENT_LIST'
export const TABLE_LOADING = 'realPage.TABLE_LOADING'
export const SEARCH_LIST = 'realPage.SEARCH_LIST'
// ------------------------------------
// Actions
// ------------------------------------
...
export function reloadTable() {
    return function (dispatch, getState) {
      let state = getState();
      let tableState = state.debug.realTable;
      ...
      // get data
      return http.post('/pointData/getRealtimeWithPages',{
  ...
  export function searchList(keyWordList){
    return function(dispatch,getState){
      ...
      dispatch(saveKeyWordList(keyWordList))
      dispatch(tableLoading(true)) //开始loading
      if(!(window.localStorage.getItem('pageSize'))){
        window.localStorage.setItem('pageSize',100)
      }
...
export function saveKeyWordList(keyWordList){
  return {
    type : SEARCH_LIST,
    keyWordList
  }
  ...
  export default function RealTableReducer (state = initialState, action) {
