        ...
        return (
            <div>
                <Modal
                    ...
                    title="点位选择"
                    visible={modal.type === modalTypes.AI_INPUT_POINT_MODAL}
                    onCancel={hidePointModal}
                    // destroyOnClose={true} 
                    maskClosable={false}
                    width={600}
                    footer={[
                        <Button key="ok" type="primary" size="large" onClick={handleOk} disabled={!selectedIdsInput.length}>
                            确定
                        </Button>,
                ...
                >
                    ...
                    <div className={inputToggleClass} style={{ marginBottom: '10px' }}>
                        <Search
                            ...
                            onSearch={value => searchPointDataInput(value)}
                    ...
                    <Table
                        ...
                        rowSelection={{
                            type: 'radio',
                            selectedRowKeys: selectedIdsInput,
                ...
                <AddVPointModal
                    ...
                    searchPointData= {searchPointDataInput}
