...
const MaintenAddView = Form.create()(
    class extends React.PureComponent{
        ...
        //点击提交表单时触发
        onOk(e){
            const {hideModal,form,addFunction,searchRecord,hideAdd} = this.props
            e.preventDefault()
        ...
        render(){
            ...
            return (
                <Modal
                    title='添加投产记录'
                    visible={table.hideAddData?table.hideAddData:false}
                    onCancel={this.hide}
                    onOk={this.onOk}
                >
                    <Form>
